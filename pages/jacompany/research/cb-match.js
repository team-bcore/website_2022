    ...
    <div className="">
      <>
        <NextSeo
          ...
          canonical="https://www.bcore.biz/research/cb-match"
          openGraph={{
      ...
      <div className="px-4 py-24 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-32">
        <div className="max-w-screen-sm sm:mx-auto">
          ...
          <p className="font-noto text-gray-900 text-2xl">
            Preventing Human Error at the vehicle manufacturing plant:Using
            “Colorbit” and iPhones to Check the Proper Connection of Hoses and
            Fittings
          </p>
          <br></br>
          ...
          <p className="my-2 font-noto text-gray-900 text-base">1.はじめに</p>
          <p className="font-ud text-gray-700 text-base">
            &nbsp;&nbsp;車両のエンジン部品製造に使用される鋳造用金型には、冷却用ホースと冷却に使用した温水を排出するホースを接続する必要がある。鋳造用金型には継手がついており、ホースの継手の配管作業は作業員が定期的に行っている。
            <br></br>
            &nbsp;&nbsp;ホースと継手のつなぎ替え作業の際、配管が正しいかを目視点検を行っていた。その際、ヒューマンエラーによる誤配管が発生することによる損害が起きており、これらヒューマンエラーを完全に排除する目的で、
            IT技術によるミスの生じづらい配管確認の検討を行うこととなる。
            <br></br>
            &nbsp;&nbsp;当初は2次元コードの導入検討が行われたが、小口径のホースの表面が湾曲しているため、リーダーで読み取らせることが困難であり導入は見送られた。また、
            RFID導入は鋳造用金型が金属製かつ水濡れもあるため検討されなかった。そこで、小口径のホースに貼り付けても読取りが容易で自由形状の「カラービット」が着目され、ビーコア㈱開発の可視化ソリューションの採用に至った（図1）。
          </p>
          ...
          <p className="font-ud text-gray-700 text-base pb-4">
            ...
            <br></br>
            ②一度に複数セットのホースと継ぎ手の読取りができ、1セットずつの作業よりも作業効率が高い。シールに多少の傷がある場合（図2）や、湾曲部で使用されていても読取りが可能。
            <br></br>
            ③ホースと継手の接続確認作業のログを画像で保存でき、作業時刻と作業担当者の情報と合わせて外部送信する機能も実装。これにより、いつ誰がどこの接続確認作業をしたのかの記録が正確に保存できる。
          </p>
          <Image
            className="rounded"
            ...
            alt="CBマッチイメージ1"
          />
          <p className="font-ud text-gray-700 text-base text-center pb-6">
            図1&nbsp;&nbsp;スマートフォン撮像写真（左）と試験装置を撮像している様子
          </p>
          <Image
            className="rounded"
            ...
            alt="CBマッチイメージ2"
          />
          <p className="font-ud text-gray-700 text-base text-center">
            図2&nbsp;&nbsp;傷のあるカラービット
          </p>
          <br></br>
          ...
          <p className="font-ud text-gray-700 text-base">
            ...
            <br></br>
            接着部の材質と油分による汚れなどによりカラービットの貼り付けが標準的なラベル素材では困難であった。ラベルの基材選定や粘着力調整、形状を工夫することで最適化を行った。
          </p>
          <p className="font-ud text-gray-700 text-base">
            &nbsp;&nbsp;（2）スマートフォンの機種選定
            <br></br>
            ...
            <br></br>
            &nbsp;&nbsp;そこで、カメラ性能が安定しているiPhoneの最新機種を選定し、アプリをAndroidからiOSへと移植することでエンドユーザーの要求基準を満たすことができた。
          </p>
          <p className="font-ud text-gray-700 text-base">
            &nbsp;&nbsp;（3）アプリの現場ニーズの反映
            <br></br>
          ...
          <p className="mb-2 font-noto text-gray-900 text-base">5.まとめ</p>
          ...
          />
          <p className="font-ud text-gray-700 text-base text-center">
            <a href="https://pub.nikkan.co.jp/magazine_series/detail/0005">
