...
<div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
  ...
  <div>
    <div className="relative w-full transition-shadow duration-300 hover:shadow-xl">
      <Image
        className=""
        src="/images/News/ColorbitDemo.jpg"
        height={1080}
        width={1920}
        alt="サムネイル"
      />
      <a
        href="https://youtu.be/-dwZE-Ccwf8"
    ...
    <p className="mt-4 text-base font-ud text-gray-700">
      {t("text-left")}
    </p>
  </div>
  ...
  <div>
    <div className="relative w-full transition-shadow duration-300 hover:shadow-xl">
      <Image
        className=""
        src="/images/News/FoodFactory.jpg"
        height={1080}
        width={1920}
        alt="サムネイル"
      />
      <a
        href="https://youtu.be/-60anfnZVmY"
        aria-label="Play Video"
        className="absolute inset-0 flex items-center justify-center w-full h-full transition-colors duration-300 bg-gray-900 bg-opacity-50 group hover:bg-opacity-25"
      >
        <div className="flex items-center justify-center w-16 h-16 transition duration-300 transform bg-red-700 rounded-full shadow-2xl group-hover:scale-110">
