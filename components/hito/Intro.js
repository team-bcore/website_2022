      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="mx-auto sm:text-center lg:max-w-2xl">
          ...
          <p className="font-ud max-w-xl mb-4 text-base text-gray-700 sm:mx-auto">
            また、2021年6月から、食品を扱うあらゆる業者に
            <span className="text-cyan-500">「HACCP（ハサップ）」</span>
            に沿った衛生管理制度が、完全義務化されました。<br></br>
            HACCP（ハサップ）とは、食品の各製造過程で異物混入や食中毒菌などの汚染等の危害が発生する恐れがないか予測・分析し、事前に阻止するための食品衛生管理の手法で、
            <span className="text-cyan-500">
              HACCPに沿った衛生管理を実施するには、「いつ・どこの部屋に・だれが入ったのか」
            </span>
            を管理する必要があります。
          </p>
        </div>
