                ...
                />
                 <div className="absolute inset-0 bg-gray-800 bg-opacity-25" />
                    ...
                    <div className="px-6 py-8 border border-t-0 rounded-b sm:px-8">
                        ...
                        パナソニック株式会社が提供するIoTカメラ「Vieureka」を使用しています。
                        <br></br>
                        <br></br>
                        </p>
                        <button
                            type="submit"
                            className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-teal-400 hover:bg-gray-400 focus:shadow-outline focus:outline-none"
                        >
                            Read more
                        </button>
                    </div>
