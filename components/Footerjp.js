        ...
        <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          <div className="md:max-w-md lg:col-span-2">
            ...
            <div className="mt-4 lg:max-w-sm">
              <p className="font-ud text-base text-gray-700 md:text-lg"></p>
              <p className="mt-4">
          ...
          <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
            <div>
              ...
              <ul className="mt-2 space-y-2">
                <li className="font-ud text-md text-slate-800">
                  <Link href="/hito">入退室管理</Link>
                </li>
                <li className="font-ud text-md text-slate-800">
                  <Link href="/mono-monitoring">モノ常時管理</Link>
                </li>
                <li className="font-ud text-md text-slate-800">
                  <Link href="/ichiservice">位置管理</Link>
                </li>
                <li className="font-ud text-md text-slate-800">
            ...
            <div>
              ...
              <ul className="mt-2 space-y-2">
                <li className="font-ud text-md text-slate-800">
                  <Link href="/jacompany/research/">ビーコアのR&D情報</Link>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="mt-2 space-y-2">
                <li className="font-ud text-md text-slate-800">
                  <Link href="/jacompany">会社紹介</Link>
                </li>
                <li className="font-ud text-md text-slate-800">
                  <Link href="/newspage">ニュース</Link>
                </li>
                <li className="font-ud text-md text-slate-800">
                  <Link href="/blogpage">ブログ</Link>
                </li>
                <li className="font-ud text-md text-slate-800">
