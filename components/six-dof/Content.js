      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="flex flex-col items-start max-w-screen-sm md:flex-row sm:mx-auto">
          <div className="py-4">
            ...
            <div className="pt-8">
              <Link href="jacompany/research/6d">
                <a className="relative px-5 py-3 overflow-hidden font-medium text-gray-600 bg-gray-200 border border-gray-200 rounded-lg shadow-inner group">
