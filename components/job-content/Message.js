        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-16">
            <div className="py-16 grid gap-10 lg:grid-cols-2">
                <div className="pt-12 lg:pr-10">
                    ...
                    <p className="pt-2 mb-3 font-ud text-gray-800 text-lg">ビーコア株式会社 代表取締役社長</p>
                    ...
                    <p className="text-gray-700 font-ud leading-relaxed">
                        我が国を取り巻く状況は厳しく、国際競争力の低下、G7で最低の労働生産性と情けない状況になっています。我慢や忍耐を強いられる単純作業、見直されない定型業務の繰り返し、なかなか進まないデジタル化、新しい技術導入への抵抗感、・・・そういった不合理や不条理の積み重なりや過去のやり方へのしがみつきがその要因と考えられます。<br></br>我々が目指すのは、技術と創意工夫により、社会で働く人々を無理・無駄・不合理から開放する一助となることです。
