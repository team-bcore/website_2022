export default function Herosolutions() {
  return (
    <div className="bg-Job-solutions-hero bg-cover bg-no-repeat">
        ...
        <div className="max-w-xl sm:mx-auto lg:max-w-2xl">
          <div className="flex flex-col sm:text-center sm:mb-0">
            <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
              <h2 className="max-w-xl mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-white sm:text-5xl md:mx-auto">
                提供するソリューション
              </h2>
            </div>
          </div>
