export default function Heroprivacy() {
  return (
    <div className="">
      <div className="bg-Job-privacy-hero bg-cover bg-no-repeat">
          ...
          <div className="max-w-xl sm:mx-auto lg:max-w-2xl">
            <div className="flex flex-col sm:text-center sm:mb-0">
              <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                <h2 className="max-w-2xl mb-6 font-sans text-2xl font-bold leading-none tracking-tight text-white sm:text-4xl md:mx-auto">
                  採用活動での個人情報の取り扱いについて
                </h2>
              </div>
            </div>
