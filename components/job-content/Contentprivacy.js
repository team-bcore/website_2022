    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-16">
      <div className="max-w-screen-sm sm:text-center sm:mx-auto">
        <p className="pb-8 text-left font-ud text-base text-gray-700 md:text-lg">
          ...
          <br></br>
          本ポリシーにおける「個人情報」、「個人データ」および「保有個人データ」は、個人情報の保護に関する法律（平成15年法律第57号。以下「個人情報保護法」といいます。）において使用する用語の例によります。
        </p>
        <p className="pb-8 text-left font-ud text-base text-gray-700 md:text-lg">
          1. 取得する情報<br></br>
        ...
        <p className="pb-8 text-left font-ud text-base text-gray-700 md:text-lg">
          ...
          在留カードの有無、自己PR用の成果物その他エントリーフォーム（採用活動への応募を目的として応募者から当社に提供された書類等であって、履歴書、職務経歴書、エントリーシート等の形式を問いません。）に記載された情報
          <br></br>●
