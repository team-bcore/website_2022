                ...
                <div className="grid grid-cols-1 gap-16 row-gap-8 lg:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p className="font-ud text-gray-700">
                                ...
                                <ul className="list-disc">
                                    <li>彩色兼備〜モノ管理〜ご利用マニュアルデモ利用版</li>
                                    <li>彩色兼備サンプルタグ枠あり</li>
                                    <li>彩色兼備モノサンプルタグ枠なしZT31176推奨</li>
                                </ul>
                                <br />
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <p className="font-ud text-gray-700">
                                ご利用いただいているタグサイズのままで、タグ数を増やすことはできません。オプションプランの変更をすることで、タグ数を増加させることは可能です。<br></br>ただし、親タグ子タグの張り替えが必要となります。
                                <br />
                                <br />
                            </p>
                        </div>
