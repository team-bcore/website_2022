        ...
        <div className="bg-neutral-900">
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                ...
                <div className="grid gap-4 row-gap-5 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="opacity-70 bg-neutral-700 flex flex-col justify-between p-5 border rounded shadow-sm">
                        <div>
                            <h6 className="text-gray-300 mb-2 font-ud leading-5 text-xl">ミッションとポリシー</h6>
                            <p className="text-gray-300 mb-3 font-ud text-base mt-8">
                                ビーコアがお客様に掲げるミッションとポリシー
                            </p>
                        </div>    
                    </div>
