        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-40">
            <div className="max-w-screen-sm sm:text-center sm:mx-auto">
                ...
                <div className="text-left">
                    ...
                    <p className="pt-2 font-ud text-base text-gray-700 md:text-lg sm:px-4">
                        OKIクロステック株式会社<br></br>五洋建設株式会社<br></br>株式会社サトー<br></br>スリーエム ジャパン株式会社<br></br>大日本印刷株式会社<br></br>
                        東芝システムテクノロジー株式会社<br></br>株式会社トーショー<br></br>日鉄ソリューションズ株式会社<br></br>任天堂株式会社<br></br>パナソニック株式会社<br></br>
